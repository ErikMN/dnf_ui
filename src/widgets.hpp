...
void pending_transaction_toggle_install_for_package(SearchWidgets *widgets, const PackageRow &pkg);
void pending_transaction_toggle_remove_for_package(SearchWidgets *widgets, const PackageRow &pkg);
void pending_transaction_toggle_reinstall_for_package(SearchWidgets *widgets, const PackageRow &pkg);
