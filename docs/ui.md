...
the user presses Apply. The window applies repository enable and disable changes
through dnf5daemon, then reloads the repository list through a fresh daemon
session.
