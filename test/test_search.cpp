...
TEST_CASE("Search exact mode does not match partial substring")
{
  ...
  auto exact = dnf_backend_search_available_package_rows_interruptible("ba", nullptr);
...
TEST_CASE("Search returns empty for impossible package name")
{
  ...
  auto results =
      dnf_backend_search_available_package_rows_interruptible("___definitely_not_a_real_package_987654___", nullptr);
